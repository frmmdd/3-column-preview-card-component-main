export const cards = [
  {
    icon: 'https://main--glittery-custard-95fa90.netlify.app/src/assets/icon-sedans.svg',
    title: 'SEDANS',
  ...
  {
    icon: 'https://main--glittery-custard-95fa90.netlify.app/src/assets/icon-suvs.svg',
    title: 'SUVS',
  ...
  {
    icon: 'https://main--glittery-custard-95fa90.netlify.app/src/assets/icon-luxury.svg',
    title: 'LUXURY',
